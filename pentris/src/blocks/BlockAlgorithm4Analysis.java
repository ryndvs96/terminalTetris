...
public class BlockAlgorithm4Analysis {
	...
	public static void main(String[] args) {
		...
		Blocks blocks = (new BlockAlgorithm4Analysis()).new Blocks(size);
		blocks.build();
		...
		System.out.println(String.format(time + " seconds : " + comma(newBlocks) 
				+ " new Blocks() : %.3f megabytes used : For " + size + " block piece. : " + blocks.blocks.size() + " pieces", memoryUsed));
		all.size();
	}
	public class Blocks {
